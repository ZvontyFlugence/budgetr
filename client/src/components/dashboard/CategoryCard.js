...
export default function CategoryCard(props) {
  ...
  const submitEditCategory = () => {
    ...
    let oldName = catName;
    fetch('http://0.0.0.0:5000/edit-category', {
      method: "POST",
      headers: {
        'Content-Type': 'application/json',
        'Authorization': localStorage.getItem('token')
  ...
  const deleteCategory = name => {
    fetch('http://0.0.0.0:5000/delete-category', {
      method: "DELETE",
      headers: {
        'Content-Type': 'application/json',
        'Authorization': localStorage.getItem('token')
  ...
  const submitEditExpense = () => {
    ...
    fetch('http://0.0.0.0:5000/edit-expense', {
      method: "POST",
      headers: {
        'Content-Type': 'application/json',
        'Authorization': localStorage.getItem('token')
  ...
  const deleteExpense = () => {
    fetch('http://0.0.0.0:5000/delete-expense', {
      method: "DELETE",
      headers: {
        'Content-Type': 'application/json',
        'Authorization': localStorage.getItem('token')
